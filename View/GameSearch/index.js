...
const render = () => {
  ...
  <input class="appearance-none  h-12 block w-full text-left bg-white dark:border-slate-400 dark:text-white dark:bg-slate-700 text-gray-700 border  rounded-2xl py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-gray-200" id="grid-first-name" type="text">
</div>`;
};
